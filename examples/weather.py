...
from kivy.properties import ObjectProperty, ListProperty, NumericProperty,\
    StringProperty  # importing kivy properties
from kivy.network.urlrequest import UrlRequest
from kivy.uix.listview import ListItemButton
import json
# importing BoxLayout widget since i don't want to create a dynamic class
# importing the app class so as to run the damn application
...
class AddLocationForm(BoxLayout):
    ...
    def found_location(self, request, data):
        ...
        .Iis a syntax for storing and exchanging data.Its an alternative of
...
class CurrentLocation(BoxLayout):
    ...
    def update_weather(self):
        ...
        request2 = UrlRequest(weather_url, on_success=self.weather_founded,
                              on_failure=self.weather_failure,
    ...
    def weather_founded(self, request2, data2):
        ...
        data2 = json.loads(data2.decode()) if not isinstance(data2, dict)\
            else data2
